...
static void cmt_counter_start_priority( uint32_t channel,
                                        cmt_priority_t priority );
static void cmt_counter_stop( uint32_t channel );
static bool cmt_setup_channel( uint32_t channel,
...
static bool cmt_create( uint32_t frequency_hz,
                        ...
                        cmt_modes_t mode,
                        uint32_t * channel );
static bool cmt_create_priority( uint32_t frequency_hz,
                                 void ( * callback )( void * pdata ),
                                 cmt_modes_t mode,
                                 uint32_t channel,
                                 cmt_priority_t priority );
 ...
 */
bool R_CMT_CreatePeriodicAssignChannelPriority( uint32_t frequency_hz,
                                                void ( * callback )( void * pdata ),
                                                uint32_t channel,
                                                cmt_priority_t priority )
{
 ...
 */
bool R_CMT_CreateOneShotAssignChannelPriority( uint32_t period_us,
                                               void ( * callback )( void * pdata ),
                                               uint32_t channel,
                                               cmt_priority_t priority )
{
