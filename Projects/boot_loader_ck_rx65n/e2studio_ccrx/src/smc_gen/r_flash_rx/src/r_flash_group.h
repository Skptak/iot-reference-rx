...
extern flash_err_t r_flash_erase( flash_block_address_t block_start_address,
                                  uint32_t num_blocks );
extern flash_err_t check_cf_block_total( flash_block_address_t block_start_address,
                                         uint32_t num_blocks );
#ifndef FLASH_NO_BLANK_CHECK
    extern flash_err_t r_flash_blankcheck( uint32_t address,
                                           uint32_t num_bytes,
                                           flash_res_t * result );
#endif
extern flash_err_t r_flash_write( uint32_t src_address,
                                  uint32_t dest_address,
                                  uint32_t num_bytes );
extern flash_err_t r_flash_control( flash_cmd_t cmd,
                                    void * pcfg );
