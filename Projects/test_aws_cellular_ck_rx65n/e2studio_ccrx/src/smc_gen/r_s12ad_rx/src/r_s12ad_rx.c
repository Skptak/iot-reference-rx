...
***********************************************************************************************************************/
    ...
    || defined( BSP_MCU_RX24U ) || defined( BSP_MCU_RX671 ) )
                      ...
                      uint16_t * const p_data )
{
    ...
    || defined( BSP_MCU_RX24U ) || defined( BSP_MCU_RX671 ) )
        ...
        #endif /* if ( defined( BSP_MCU_RX64M ) || defined( BSP_MCU_RX65_ALL ) || defined( BSP_MCU_RX71M ) || defined( BSP_MCU_RX72M ) || defined( BSP_MCU_RX66N ) || defined( BSP_MCU_RX72N ) || defined( BSP_MCU_RX671 ) ) */
    ...
    #endif /* if ADC_CFG_PARAM_CHECKING_ENABLE == 1 */
...
adc_err_t R_ADC_ReadAll( adc_data_t * const p_all_data )
{
    ...
    || defined( BSP_MCU_RX140 ) || defined( BSP_MCU_RX660 ) )
        ...
        return ADC_SUCCESS;
           ...
           || definedBSP_MCU_RX140 || definedBSP_MCU_RX660 */
...
adc_err_t R_ADC_Close( uint8_t const unit )
{
    ...
    || defined( BSP_MCU_RX140 ) || defined( BSP_MCU_RX660 ) )
        ...
        return ADC_SUCCESS;
           ...
           || definedBSP_MCU_RX72N || definedBSP_MCU_RX23E_A  || definedBSP_MCU_RX23T \
           || definedBSP_MCU_RX24T || definedBSP_MCU_RX24U    || definedBSP_MCU_RX671 \
           || definedBSP_MCU_RX140 || defined(BSP_MCU_RX660) */
 ...
 ******************************************************************************/
    R_BSP_ATTRIB_STATIC_INTERRUPT void adc_gbadi_isr( void )
    {
        ...
        * && !definedBSP_MCU_RX671 && !defined(BSP_MCU_RX660)) */
