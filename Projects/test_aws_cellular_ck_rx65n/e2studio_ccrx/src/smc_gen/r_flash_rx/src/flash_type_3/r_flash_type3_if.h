...
***********************************************************************************************************************/
    ...
    #define FLASH_FCU_INT_ENABLE \
    FLASH.FAEINT.BYTE = 0x90;    \
    FLASH.FRDYIE.BYTE = 0x01;
    #define FLASH_FCU_INT_DISABLE \
...
***********************************************************************************************************************/
    ...
    extern flash_err_t flash_api_lockbit_set( flash_block_address_t block_address,
                                              uint32_t num_blocks );
    extern flash_err_t flash_lockbit_read( flash_block_address_t block_address,
