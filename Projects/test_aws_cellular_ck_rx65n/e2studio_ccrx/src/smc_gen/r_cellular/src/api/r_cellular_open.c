 ...
 *********************************************************************************************************************/
static e_cellular_err_t cellular_init( st_cellular_ctrl_t * const p_ctrl,
                                       const st_cellular_cfg_t * const p_cfg );
static e_cellular_err_t cellular_config_init( st_cellular_ctrl_t * const p_ctrl,
                                              const st_cellular_cfg_t * const p_cfg );
static void cellular_open_fail( st_cellular_ctrl_t * const p_ctrl,
                                const uint8_t open_phase );
