...
***********************************************************************************************************************/
    ...
    uint16_t phy_read( uint32_t ether_channel,
                       uint16_t reg_addr );
    void phy_write( uint32_t ether_channel,
                    uint16_t reg_addr,
                    uint16_t data );
    static void phy_preamble( uint32_t ether_channel );
    static void phy_reg_set( uint32_t ether_channel,
                             uint16_t reg_addr,
                             int32_t option );
    static void phy_reg_read( uint32_t ether_channel,
                              uint16_t * pdata );
    static void phy_reg_write( uint32_t ether_channel,
                               uint16_t data );
    ...
    static int16_t phy_get_pir_address( uint32_t ether_channel,
                                        volatile uint32_t R_BSP_EVENACCESS_SFR ** pppir_addr );
...
* Return Value : none
***********************************************************************************************************************/
    void phy_start_autonegotiate( uint32_t ether_channel,
                                  uint8_t pause )
    {
...
***********************************************************************************************************************/
    int16_t phy_set_autonegotiate( uint32_t ether_channel,
...
*               : R_PHY_ERROR   error
***********************************************************************************************************************/
    int16_t pmgi_access( uint32_t channel,
                         uint16_t address,
                         uint16_t data,
                         uint16_t dir )
    {
