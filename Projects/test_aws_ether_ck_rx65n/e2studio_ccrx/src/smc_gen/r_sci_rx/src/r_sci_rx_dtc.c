 ...
 *********************************************************************************************************************/
    sci_err_t sci_dtc_info_transfer_create( sci_hdl_t const hdl,
                                            sci_dtc_info_transfer_t ** p_info_transfer );
 ...
 *********************************************************************************************************************/
        sci_err_t sci_txfifo_dtc_create( sci_hdl_t const hdl,
                                         uint8_t * p_src,
 ...
 *                    Create DTC NOT successfully
 *********************************************************************************************************************/
        sci_err_t sci_rxfifo_dtc_create( sci_hdl_t const hdl,
                                         uint8_t * p_dst,
                                         uint16_t const length )
        {
 ...
 *                    Create DTC NOT successfully
 *********************************************************************************************************************/
    sci_err_t sci_rx_dtc_create( sci_hdl_t const hdl,
                                 uint8_t * p_dst,
                                 uint16_t const length )
    {
        sci_fifo_ctrl_t * p_rctrl;
 ...
 *                    Create DTC NOT successfully
 *********************************************************************************************************************/
    sci_err_t sci_tx_dtc_create( sci_hdl_t const hdl,
                                 uint8_t * p_src,
                                 uint16_t const length )
    {
        sci_fifo_ctrl_t * p_tctrl;
