...
***********************************************************************************************************************/
    ...
    extern flash_err_t flash_erase( uint32_t block_address,
                                    uint32_t num_blocks );
    extern flash_err_t flash_blankcheck( uint32_t start_address,
                                         uint32_t num_bytes,
                                         flash_res_t * result );
    extern flash_err_t flash_write( uint32_t src_start_address,
